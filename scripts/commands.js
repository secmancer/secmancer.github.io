var linkedin = "https://www.linkedin.com/in/adan-silva-7939a2273/";
var github = "https://github.com/secmancer/";
...
whois = [
  ...
  "I am currently attending Allan Hancock College as I have taken mutliple dual enrollement classes while in high school.",
  "As of me writing this, I am waitlisted at Cal Poly SLO for Computer Science. I hope to recieve an acceptance soon!",
  "I have also been a participate for the FIRST Robotics Competition for 4 years and have been with the organization for 6+.",
  "As an FIRST alumni, I am currently mentoring my former team in my spare time and where ever I can.",
  "I have programming experience in C++/C and Java, and I also learning how to use Python and Go.",
  "While I am not focused on web development, I do have some experience with HTML, CSS, and Java.",
  "I also have experience working with Git and GitHub, where I was in charge of merging pull requests for a software development team.",
  "I have experience working with the Windows operating system and comfortable working with Linux systems as well.",
  "In my freetime, I like playing with my dogs, hanging out with my friends, or listening to the latest Darknet Diaries epsiode!",
  "Thank you for taking the time to read about me. Feel free to look around this site!",
  "<br>"
];
...
projects = [
  "<br>",
  '<a href="https://github.com/frc3512/Robot-2023">Robot 2023:</a> Used Java and various libraries to develop the code for the 2023 robot.',
  '<a href="https://github.com/frc3512/Robot-2022">Robot 2022:</a> Used C++ and various libraries to develop the code for the 2022 robot.',
  '<a href="https://github.com/frc3512/SwerveBot-2022">SwerveBot2022:</a> Used Java and various libraries to develop a soild swerve drive template that a bunch of teams utilize for the 2023 season.',
  '<a href="https://github.com/frc3512/frc3512.github.io">frc3512.github.io:</a> Used HTML, CSS, and JS to write documentation and tutorials for software member.',
  '<a href="https://github.com/secmancer/OhWhatFun">OhWhatFun!:</a> Built a Minecraft mod that adds ridable sleds into the world and submitted it for a modjam.',
  '<a href="https://github.com/secmancer/GameBoy-Picture">GameBoyPicture:</a> Simple GameBoy app I built for a hackathon.',
];
...
"                                ",
"                            ",
"                             _______  ______   _______  __    _    _______  ___   ___      __   __  _______ ",
"  -----------,-|            |   _   ||      | |   _   ||  |  | |  |       ||   | |   |    |  | |  ||   _   |",
"           ,','|            |  |_|  ||  _    ||  |_|  ||   |_| |  |  _____||   | |   |    |  |_|  ||  |_|  |",
"---------,','  |            |       || | |   ||       ||       |  | |_____ |   | |   |    |       ||       |",
"         ||    |            |       || |_|   ||       ||  _    |  |_____  ||   | |   |___ |       ||       | ",
"         ||    |            |   _   ||       ||   _   || | |   |   _____| ||   | |       | |     | |   _   |",
"         ||    |______      |__| |__||______| |__| |__||_|  |__|  |_______||___| |_______|  |___|  |__| |__| ",
"         ||    |     ,|      ",
"         ||  ,'    ,' |              Student who is really obsessed with cybersecurity and IT!",
"         ||,'    ,'   |                   College Freshmen, attending Allan Hancock College",
"_________|/    ,'     |                    Waitlisted at Cal Poly SLO for Computer Science",
"_____________,'      ,',              COMPTIA ITF+ Certified, testing for Security+ in July!",
"             |     ,','     ",
"             |   ,','    ",
"             | ,',' ",
"_____________|','   ",
